...
impl PositionEvaluator {
    pub fn evaluate(board: &Board) -> i32 {
        ...
        for (position, square) in board.squares.iter().enumerate() {
            if let Some((piece, color)) = square.0 {
                let bonus: i32 = Self::piece_value(piece, position, color);
    ...
    fn piece_value(piece: Piece, position: usize, color: Color) -> i32 {
        ...
        match piece {
            ...
            Piece::King => KING_MIDDLEGAME_TABLE[normalized_position],
        }
    }
}
